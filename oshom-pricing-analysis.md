# Oshom Pricing Analysis — Working Document
...
Oshom is a boutique hotel with **18 rooms** (17 guest rooms + 1 master/couple suite) and **in-house F&B**.

Couples buy three products:

1. **Venue Buyout** — exclusive-use of the property for 2 or 3 nights
2. **Food & Beverage** — catering for 80 guests (tiered)
3. **Guest Rooms** — 17 rooms booked by wedding guests (offsets buyout cost for the couple)

BaliLove commission = **15%** = spread between sell (couple pays) and buy (venue keeps).

---

## Product 1: Venue Buyout

| Package | Sell (Couple Pays) | Buy (Oshom Keeps) |
|---------|-------------------|-------------------|
| 2-Night Buyout | 119,000,000 IDR | 101,150,000 IDR |
| 3-Night Buyout | 154,000,000 IDR | 130,900,000 IDR |

### How we got here

**Question to confirm:** How was the 119M / 154M sell price derived?

Looking at the page, the buyout and guest rooms are presented as the same number (119M for 2 nights), which suggests:

- 17 rooms × 3,500,000/room/night × 2 nights = **119,000,000 IDR** (sell)
- 17 rooms × 3,500,000/room/night × 3 nights = **178,500,000 IDR** (sell for rooms)
- But the venue buyout for 3 nights is **154,000,000** — a different number

So the "venue buyout" and "guest rooms" are presented as **separate line items** that happen to overlap for 2-night:
- Venue buyout = the exclusive-use fee the couple commits to
- Guest rooms = the per-room revenue from guests actually booking

The buyout model works like this:
1. Couple commits to the buyout (119M for 2 nights)
2. Guest room bookings (also 119M if all 17 fill at 3.5M/night × 2) offset the buyout
3. If rooms fill → venue is effectively "free" for the couple, they only pay F&B out of pocket
4. **Oshom carries zero risk** — the couple guarantees the buyout regardless

**Key question:** Is the venue buyout price SEPARATE from room revenue, or does room revenue offset it? The page says rooms offset the buyout, which means Oshom effectively gets paid twice (buyout guarantee + room revenue). Need to clarify the exact flow of money.

---

## Product 2: Food & Beverage (80 guests)

| Tier | Food/Head | Drinks/Head | Per Head Sell | Per Head Buy | Total Sell (80) | Total Buy (80) |
|------|-----------|-------------|---------------|--------------|-----------------|----------------|
| Standard | 700,000 | 900,000 | 1,600,000 | 1,360,000 | 128,000,000 | 108,800,000 |
| Premium | — | — | from 2,000,000 | — | — | — |
| Luxury | — | — | from 2,500,000 | — | — | — |

### Thinking

- Food at 700K/head and drinks at 900K/head = **1,600,000 IDR per head sell**
- Buy = 1,600,000 × 0.85 = **1,360,000 IDR per head**
- 80 guests × 1,600,000 = **128,000,000 IDR sell** / **108,800,000 IDR buy**
...
- The previous version benchmarked to Vedas/Saffron at 950K food + 1,150K drinks — this version is lower. Was that intentional to be more competitive?

---

## Product 3: Guest Rooms (17 rooms)

| Package | Per Room/Night Sell | Per Room/Night Buy | Total Sell (17 rooms) | Total Buy (17 rooms) |
|---------|--------------------|--------------------|----------------------|---------------------|
| 2-Night Stay | 3,500,000 | 2,975,000 | 119,000,000 | 101,150,000 |
| 3-Night Stay | 3,500,000 | 2,975,000 | 178,500,000 | 151,725,000 |

### Thinking

- 3,500,000 IDR/room/night sell = **~$220 USD** or **~$340 AUD**
- Buy = 3,500,000 × 0.85 = **2,975,000 IDR**
...
| Product | 2-Night Sell | 2-Night Buy | 3-Night Sell | 3-Night Buy |
|---------|-------------|-------------|-------------|-------------|
| Venue Buyout | 119,000,000 | 101,150,000 | 154,000,000 | 130,900,000 |
| F&B (80 guests) | 128,000,000 | 108,800,000 | 128,000,000 | 108,800,000 |
| Guest Rooms (17) | 119,000,000 | 101,150,000 | 178,500,000 | 151,725,000 |
| **Total** | **366,000,000** | **311,100,000** | **460,500,000** | **391,425,000** |

- 2-Night wedding: **$34,500 AUD** sell / **$29,300 AUD** buy (Oshom keeps)
- 3-Night wedding: **$43,400 AUD** sell / **$36,900 AUD** buy (Oshom keeps)
- BaliLove commission per wedding: ~$5,200 AUD (2-night) / ~$6,500 AUD (3-night)

---

## Annual Projection — 50 Weddings

Mix: **33 × 2-night + 17 × 3-night** (66/34 split matching Vedas demand pattern)

| Product | Annual Sell | Annual Buy (Oshom Keeps) |
|---------|-----------|------------------------|
| Venue Buyout | 6,545,000,000 | 5,563,250,000 |
| F&B (80 guests × 50) | 6,400,000,000 | 5,440,000,000 |
| Guest Rooms | 6,961,500,000 | 5,917,275,000 |
| **Total** | **19,906,500,000** | **16,920,525,000** |

- Annual Oshom revenue: **~16.9 billion IDR** (~$1.6M AUD)
- Annual BaliLove commission: **~3.0 billion IDR** (~$281K AUD)

---

## Commission Math Check

| Item | Value |
|------|-------|
| Total sell (annual) | 19,906,500,000 |
| Total buy (annual) | 16,920,525,000 |
| BaliLove commission | 2,985,975,000 |
| Commission % | 15.0% ✓ |

---

## Key Differences: This Version vs Previous Version

The **Feb 23 commit** (current) differs from the **earlier version** (which was in your local uncommitted files):

| Aspect | Previous (uncommitted) | Current (Feb 23) |
|--------|----------------------|-------------------|
| Room count | 18 rooms | 17 guest rooms (+1 couple) |
| Room rate/night | 4,000,000-5,300,000 (seasonal) | 3,500,000 (flat) |
| Venue fee | Separate 30-47M event fee | Venue buyout (119M/154M) |
| F&B food/head | 800,000-850,000 | 700,000 |
| F&B drinks/head | 1,100,000-1,150,000 | 900,000 |
| Seasonal tiers | Low/Mid/High with Vedas benchmark | Flat pricing (no seasons) |
| Per-wedding total (2-night) | 280M-395M (Oshom receives, seasonal) | 311M (Oshom receives, flat) |
| Annual (50 weddings) | 17.8B Oshom receives | 16.9B Oshom receives |
| Presentation | "Oshom receives" framing | "Sell/Buy" framing |
| Currency | GBP couple-facing | AUD couple-facing |
...
2. **17 vs 18 rooms?** Previous version used 18, current uses 17. Is room 18 the couple's suite (included in buyout)?

3. **Flat vs seasonal pricing?** Previous version had seasonal tiers benchmarked to Vedas. Current version uses flat pricing. Which approach for the client pitch?

4. **F&B rates dropped significantly.** Food went from 850K to 700K, drinks from 1,150K to 900K. Was this intentional? What can Oshom's kitchen actually deliver at these rates?
